...
public class User {
	...
	public User(
			@NotEmpty(message = "User name is required!") @Size(min = 3, max = 50, message = "User name must be between 3 and 50 characters!") @Pattern(regexp = "^[A-Za-z ]*$", message = "User name must be only letters!") String userName,
